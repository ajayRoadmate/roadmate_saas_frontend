...
export default function UpdateDistributorModalLogic(updateModalStates, updateModalTasks, tableTasks){
    ...
    var INITIAL_FORM_STATE = {
        ...
        submitEndpoint: 'channelPartner_updateDistributor', 
        inputs: [
    ...
    async function initializeForm(){
        ...
        try{
            ...
            var updateFormData = await updateModalTasks.getUpdateFormData(itemKey,itemValue, 'fetchDistributorsUpdateFormData');

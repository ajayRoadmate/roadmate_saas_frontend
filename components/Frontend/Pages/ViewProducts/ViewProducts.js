...
export default function ViewProducts() {
  ...
  const {pageStates, pageTasks} = ViewProductsLogic();
  ...
  return (
    <div className={`w-100 d-flex flex-column`}>
      ...
      <div className={`d-flex  mt-2`} >
        ...
        {/* title */}
        <div className={` page-title`} >View Products</div>

        {/* Add section */}
        <div className={`d-none d-md-flex  align-items-center ms-auto`} >

          <div onClick={()=>{ pageTasks.goToAddProductPage()} } className={`c-btn-primary ms-3`} >
            <div >Add Product</div>

...
export default function UpdateDistributorModalLogic(updateModalStates, updateModalTasks){
    ...
    async function initializeForm(){
        ...
        try{
            ...
            var updateFormData = await getUpdateFormData(itemKey,itemValue);
    ...
    function getUpdateFormData(itemKey,itemValue){

        return new Promise((resolve,reject)=>{

            var params = {item_key: itemKey, item_value: itemValue};
            var apiBaseUrl = Config.URL.apiBaseUrl;
            var path = apiBaseUrl+'fetchDistributorsUpdateFormData';

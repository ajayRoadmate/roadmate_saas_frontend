...
import UpdateShopModalLogic from './UpdateShopModalLogic'

export default function UpdateShopModal({pageStates: {updateModalStates}, pageTasks: {updateModalTasks,tableTasks}}) {

  const {states,tasks} = UpdateShopModalLogic(updateModalStates,updateModalTasks,tableTasks);

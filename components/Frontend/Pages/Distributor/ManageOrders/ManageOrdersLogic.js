...
export default function ManageOrdersLogic(){
    ...
    var tableOptions = { 
        id: 'orderTable',
        endPoint: 'distributor_fetchAllOrderTableData',
    ...
    function action_cancel(selectedItem){
        ...
        setCancelModalState((currentState)=>{
            ...
            return {...currentState, isOpen: true, endpoint: 'distributor_cancelOrder',item: item, modalTitle: "Cancel Order", modalDescription: "Are you sure you want to cancel this order ?"}
        });

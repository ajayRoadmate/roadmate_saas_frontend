...
export default function  TableFooterLogic(TableState, tableTasks, tableOptions){
    ...
    async function fetchTableDataByPage(page){

        if(page > 0){

            var path = Config.URL.apiBaseUrl + TableState.endPoint;
            var params = {page: page, rows_count: TableState.rowsCount, filter_column: TableState.filterInfo.filterColumn, filter_state:  TableState.filterInfo.filterState, search: TableState.search};
            
            if(tableOptions.itemKey && tableOptions.itemValue){

                params = {page: page, rows_count: TableState.rowsCount, filter_column: TableState.filterInfo.filterColumn, filter_state:  TableState.filterInfo.filterState, search: TableState.search, item_key: tableOptions.itemKey,item_value: tableOptions.itemValue};
            }

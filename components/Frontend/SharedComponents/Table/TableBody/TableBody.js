                    ...
                    <TextCell data={rowIndex+TableState.paginationInfo.from} />
                    {
                        TableState.columns.map((columnElement,cellIndex)=>{
                            ...
                            if(columnElement.type == "text"){
                                ...
                                return(
                                    <ActionCell key={tableId+'_cell_'+rowIndex+'_'+cellIndex} id={tableId+'_cell_'+rowIndex+'_'+cellIndex} rowElement={rowElement}  actionState={rowElement[columnElement.name]} />
                                )
                            }
                            else{

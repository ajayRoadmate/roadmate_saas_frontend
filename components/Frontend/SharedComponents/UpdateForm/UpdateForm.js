...
import UpdateFormLogic from './UpdateFormLogic';
import styles from './UpdateForm.module.css';


export default function UpdateForm({fromStates, formTasks, updateItem}) {

    const {states,tasks} = UpdateFormLogic(fromStates, formTasks, updateItem);
